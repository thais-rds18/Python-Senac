...
def telaProfessores():
    class TelaProfessores:
        def __init__(self, janela_professores_geral):
            ...
            self.iconeesp1 = tk.PhotoImage(file=r'..\ProjetoFinal\especialidades2.png')
            self.label_iconeesp1 = tk.Label(self.professores, image=self.iconeesp1)
            self.label_iconeesp1.place(relx=0.35, rely=0.35)
            self.espProf1 = tk.Label(self.professores, text='', font='Inter 15')
            self.espProf1.place(relx=0.38, rely=0.35)
            self.iconefone1 = tk.PhotoImage(file=r'..\ProjetoFinal\fone2.png')
            self.label_iconefone1 = tk.Label(self.professores, image=self.iconefone1)
            self.label_iconefone1.place(relx=0.35, rely=0.395)
            self.foneProf1 = tk.Label(self.professores, text='', font='Inter 15')
            self.foneProf1.place(relx=0.375, rely=0.39)
            self.iconeEmail1 = tk.PhotoImage(file=r'..\ProjetoFinal\email2.png')
            self.label_iconeEmail1 = tk.Label(self.professores, image=self.iconeEmail1)
            self.label_iconeEmail1.place(relx=0.48, rely=0.39)
            self.emailProf1 = tk.Label(self.professores, text='', font='Inter 15')
            self.emailProf1.place(relx=0.51, rely=0.39)
            self.iconeCpf1 = tk.PhotoImage(file=r'..\ProjetoFinal\cpf2.png')
            self.label_iconeCpf1 = tk.Label(self.professores, image=self.iconeCpf1)
            self.label_iconeCpf1.place(relx=0.72, rely=0.39)
            self.cpfProf1 = tk.Label(self.professores, text='', font='Inter 16')
            self.cpfProf1.place(relx=0.75, rely=0.39)
            ...
            self.iconeesp2 = tk.PhotoImage(file=r'..\ProjetoFinal\especialidades2.png')
            self.label_iconeesp2 = tk.Label(self.professores, image=self.iconeesp2)
            self.label_iconeesp2.place(relx=0.35, rely=0.52)
            self.espProf2 = tk.Label(self.professores, text='', font='Inter 15')
            self.espProf2.place(relx=0.38, rely=0.52)
            self.iconefone2 = tk.PhotoImage(file=r'..\ProjetoFinal\fone2.png')
            self.label_iconefone2 = tk.Label(self.professores, image=self.iconefone2)
            self.label_iconefone2.place(relx=0.35, rely=0.56)
            self.foneProf2 = tk.Label(self.professores, text='', font='Inter 15')
            self.foneProf2.place(relx=0.375, rely=0.56)
            self.iconeEmail2 = tk.PhotoImage(file=r'..\ProjetoFinal\email2.png')
            self.label_iconeEmail2 = tk.Label(self.professores, image=self.iconeEmail2)
            self.label_iconeEmail2.place(relx=0.48, rely=0.56)
            self.emailProf2 = tk.Label(self.professores, text='', font='Inter 15')
            self.emailProf2.place(relx=0.51, rely=0.56)
            self.iconeCpf2 = tk.PhotoImage(file=r'..\ProjetoFinal\cpf2.png')
            self.label_iconeCpf2 = tk.Label(self.professores, image=self.iconeCpf2)
            self.label_iconeCpf2.place(relx=0.72, rely=0.475)
            self.cpfProf2 = tk.Label(self.professores, text='', font='Inter 16')
            self.cpfProf2.place(relx=0.75, rely=0.475)
            ...
            self.iconeesp3 = tk.PhotoImage(file=r'..\ProjetoFinal\especialidades2.png')
            self.label_iconeesp3 = tk.Label(self.professores, image=self.iconeesp3)
            self.label_iconeesp3.place(relx=0.35, rely=0.69)
            self.espProf3 = tk.Label(self.professores, text='', font='Inter 15')
            self.espProf3.place(relx=0.375, rely=0.69)
            self.iconefone3 = tk.PhotoImage(file=r'..\ProjetoFinal\fone2.png')
            self.label_iconefone3 = tk.Label(self.professores, image=self.iconefone3)
            self.label_iconefone3.place(relx=0.35, rely=0.73)
            self.foneProf3 = tk.Label(self.professores, text='', font='Inter 15')
            self.foneProf3.place(relx=0.375, rely=0.73)
            self.iconeEmail3 = tk.PhotoImage(file=r'..\ProjetoFinal\email2.png')
            self.label_iconeEmail3 = tk.Label(self.professores, image=self.iconeEmail3)
            self.label_iconeEmail3.place(relx=0.48, rely=0.73)
            self.emailProf3 = tk.Label(self.professores, text='', font='Inter 15')
            self.emailProf3.place(relx=0.51, rely=0.73)
            self.iconeCpf3 = tk.PhotoImage(file=r'..\ProjetoFinal\cpf2.png')
            self.label_iconeCpf3 = tk.Label(self.professores, image=self.iconeCpf3)
            self.label_iconeCpf3.place(relx=0.72, rely=0.645)
            self.cpfProf3 = tk.Label(self.professores, text='', font='Inter 16')
            self.cpfProf3.place(relx=0.75, rely=0.645)
