...
def tela_senha():
    class Janela_Recuperar_Senha:
        def __init__(self, janela):
            ...
            self.label_Cadastro_usuario = tk.Label(self.janela_recuperar_senha, text='Recuperar Senha', bg='#F5F5F5',
                                                   font='Inter 24 bold')
            ...
            self.botao_cadastrar = tk.Button(self.janela_recuperar_senha, text='Enviar', font='Inter 17 bold', fg='white', bg='#004AAD')
